...
class ProductCardE extends StatefulWidget {
  ...
  @override
  State<ProductCardE> createState() => _ProductCardEState();
}

class _ProductCardEState extends State<ProductCardE> {
