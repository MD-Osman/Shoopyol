...
class DataGiyim extends StatelessWidget {
        ...
        children: [
          SizedBox(
            ...
            child: PageView.builder(
              itemCount: Product.productG.length,
                  ...
                  children: [
                    Expanded(
                      child: SizedBox(
                        width: size.width,
                        child: Image.asset(
                          Product.productG[id].desimage[index],
                          fit: BoxFit.cover,
                        ),
                      ),
                    ),
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: Text(
                          'Detaylar: ${Product.productG[id].description}',
                      ...
                      Padding(
                        ...
                        child: Text(
                          'Fiyat : ${Product.productG[id].price}',
