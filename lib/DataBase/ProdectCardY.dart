...
class ProdectCardY extends StatefulWidget {
  ...
  @override
  State<ProdectCardY> createState() => _ProdectCardYState();
}

class _ProdectCardYState extends State<ProdectCardY> {
      ...
      child: InkWell(
        onTap: (() {
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (context) => DataYiyecek(
                id: widget.itemIndex,
                product: Product.productYs,
              ),
            ),
          );
        }),
