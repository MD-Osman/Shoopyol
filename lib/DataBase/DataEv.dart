...
class DataEv extends StatelessWidget {
        ...
        children: [
          SizedBox(
            ...
            child: PageView.builder(
              itemCount: Product.productE.length,
                  ...
                  children: [
                    Expanded(
                      child: SizedBox(
                        width: size.width,
                        child: Image.asset(
                          Product.productE[id].desimage[index],
                          fit: BoxFit.cover,
                        ),
                      ),
                    ),
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: Text(
                          'Detaylar: ${Product.productE[id].description}',
                      ...
                      Padding(
                        ...
                        child: Text(
                          'Fiyat : ${Product.productE[id].price}',
