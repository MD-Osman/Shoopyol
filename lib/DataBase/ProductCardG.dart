...
import 'package:proje_store/DataBase/DataGiyim.dart';

import 'package:proje_store/DataBase/Product.dart';

import 'package:proje_store/ozellikler/splash/presentataion/enums.dart';

class ProductCardG extends StatefulWidget {
  const ProductCardG({
    Key? key,
    required this.itemIndex,
    required this.product,
    required this.press,
    // required this.favoriPageState,
  }) : super(key: key);

  final int itemIndex;
  final Product product;
  final Function press;
  // final FavoriPageState favoriPageState;

  @override
  State<ProductCardG> createState() => _ProductCardGState();
}

class _ProductCardGState extends State<ProductCardG> {
      ...
      child: InkWell(
        onTap: (() {
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (context) => DataGiyim(
                id: widget.itemIndex,
                product: Product.productG,
              ),
            ),
          );
        }),
