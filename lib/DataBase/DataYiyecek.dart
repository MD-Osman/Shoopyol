...
class DataYiyecek extends StatelessWidget {
                  ...
                  children: [
                    Expanded(
                      child: SizedBox(
                        width: size.width,
                        child: Image.asset(
                          Product.productYs[id].desimage[index],
                          fit: BoxFit.cover,
                        ),
                      ),
                    ),
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: Text(
                          'Icindekiler: ${Product.productYs[id].description}',
                      ...
                      Padding(
                        ...
                        child: Text(
                          'Fiyat : ${Product.productYs[id].price}',
